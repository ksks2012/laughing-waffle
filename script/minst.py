...
class MINSTModel():
    ...
    def download_dataset(self):
        self.train_data = TV.datasets.MNIST("MNIST/", train=True, transform=None, target_transform=None, download=True)
        self.test_data = TV.datasets.MNIST("MNIST/", train=False, transform=None, target_transform=None, download=True)
